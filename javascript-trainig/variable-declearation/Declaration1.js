//1.Var- The var keyword is used to declare a variable that can be reassigned. It has function scope, which means that it is accessible within the function it is declared in. However, it is generally recommended to avoid using var in modern JavaScript due to its quirks and potential for bugs.
//var 
var name1='Govind';
console.log(name1);
var name1="bharath";
...
//Scope.-> Scope is all about where can we use this data?
